...
class MainWindow(QMainWindow):
    ...
    def _light_stylesheet(self) -> str:
        return """
            ...
            QWidget { font-family: "Microsoft YaHei", "Segoe UI", sans-serif; background-color: #252526; color: #CCCCCC; }
            QLabel { color: #CCCCCC; }
            QPushButton {
            ...
            QGroupBox { border: 1px solid #3C3C3C; border-radius: 4px; margin-top: 8px; font-weight: bold; color: #CCCCCC; }
            ...
            QTabBar::tab:selected { background-color: #1E1E1E; border-bottom: 2px solid #37373d; color: #FFFFFF; }
            QTabBar::tab:hover { background-color: #383838; }
            QProgressBar { border: 1px solid #555555; border-radius: 4px; text-align: center; background-color: #2D2D2D; color: #CCCCCC; }
            ...
            QLineEdit { background-color: #2D2D2D; border: 1px solid #555555; color: #CCCCCC; border-radius: 4px; padding: 2px 4px; }
